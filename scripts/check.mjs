...
if (manifest.manifest_version !== 3 || manifest.host_permissions || manifest.content_scripts || String(manifest.permissions) !== 'tabs,tabGroups,storage') throw new Error('Unexpected manifest permissions');
...
for (const asset of ['dashboard.js','dashboard.html','core.js','triage.js','rules.js','saved.js','styles.css']) await readFile(`extension/${asset}`);
